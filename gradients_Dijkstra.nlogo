...
to setup
  ...
  create-attractors nb-attractors [ init-attractor ]
  create-repulsors nb-repulsors [ init-repulsor ]
  create-followers nb-followers [ init-follower ]
  propagate
end
...
to go
  move-randomly attractors
  move-randomly repulsors
  propagate
...
to propagate
  ...
  let p (patch-set [patch-here] of attractors) ; let p patches with [any? attractors-here]
  let d 0
  while [ any? p ]
    [ ask p [ set dist d ]
      set d d + 1
